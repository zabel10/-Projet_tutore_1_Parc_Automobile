...
<div class="container mx-auto px-4 py-8">
    ...
    <div class="grid grid-cols-1 md:grid-cols-4 gap-6">
        ...
        <div class="bg-white rounded-lg shadow p-6">
            <h3 class="text-lg font-semibold text-gray-600">Total Conducteurs</h3>
            <p class="text-3xl font-bold text-green-600">{{ $stats['total_conducteurs'] }}</p>
        </div>
        <div class="bg-white rounded-lg shadow p-6">
            <h3 class="text-lg font-semibold text-gray-600">Total Missions</h3>
            <p class="text-3xl font-bold text-orange-600">{{ $stats['total_missions'] }}</p>
        </div>
        <div class="bg-white rounded-lg shadow p-6">
